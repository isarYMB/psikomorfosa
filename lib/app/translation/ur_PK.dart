const Map<String, String> ur = {
  ...
  'View All': 'View All',
  'error ': 'error ',
  'Top Rated Doctor is empty ': 'Top Rated Psychologist is empty ',
  'Home': 'Home',
  'Doctor': 'Psychologist',
  ...
  'No Doctor Registered in this Category':
      'No Psychologist Registered in this Category',
  'Price': 'Price',
  ...
  'the doctor has canceled the appointment, and your payment has been refunded':
      'the Psychologist has canceled the appointment, and your payment has been refunded',
  'the start consultation button will be active when the doctor starts the consultation':
      'the start consultation button will be active when the Psychologist starts the consultation',
  'the doctor has not started the meeting session, this button will automatically turn on when the doctor has started it':
      'the Psychologist has not started the meeting session, this button will automatically turn on when the doctor has started it',
  'The doctor hasn\'t started the consultation yet':
      'The Psychologist hasn\'t started the consultation yet',
  'Photo': 'Photo',
  'File': 'File',
  'Cancel': 'Cancel',
  ...
  'Payment for doctor ': 'Payment for Psychologist ',
  ...
  'Send': 'Send',
  'Doctor no longger exist': 'Psychologist no longger exist',
  ...
  'Register': 'Register',
  'Login': 'Login',
  'Review Doctor': 'Review Psychologist',
